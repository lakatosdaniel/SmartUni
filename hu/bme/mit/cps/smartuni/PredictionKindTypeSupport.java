...
public class PredictionKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PredictionKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PredictionKindTypeSupport _singleton
    = new PredictionKindTypeSupport();
    ...
    */
    public static PredictionKindTypeSupport get_instance() {
        return _singleton;
    }

    public static PredictionKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PredictionKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>PredictionKind</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        PredictionKind typedSrc = (PredictionKind) src;
    ...
    protected PredictionKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, PredictionKindTypeCode.VALUE, PredictionKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
