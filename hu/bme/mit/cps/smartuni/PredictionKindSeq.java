...
/**
* A sequence of PredictionKind instances.
*/
public final class PredictionKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PredictionKindSeq() {
        super(PredictionKind.class);
    }

    public PredictionKindSeq (int initialMaximum) {
        super(PredictionKind.class, initialMaximum);
    }

    public PredictionKindSeq (Collection<?> elements) {
        super(PredictionKind.class, elements);
    }

    public  PredictionKind get(int index) { 
        return (PredictionKind) super.get(index); 
    }
