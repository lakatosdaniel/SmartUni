...
/**
* A sequence of ActionKind instances.
*/
public final class ActionKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ActionKindSeq() {
        super(ActionKind.class);
    }

    public ActionKindSeq (int initialMaximum) {
        super(ActionKind.class, initialMaximum);
    }

    public ActionKindSeq (Collection<?> elements) {
        super(ActionKind.class, elements);
    }

    public  ActionKind get(int index) { 
        return (ActionKind) super.get(index); 
    }
