...
java -Djava.ext.dirs=$NDDSHOME/class ActionPublisher <domain_id>

java -Djava.ext.dirs=$NDDSHOME/class ActionSubscriber <domain_id>  
*/
...
public class ActionSubscriber {
    ...
    private static void subscriberMain(int domainId, int sampleCount) {
        ...
        try {
            ...
            String typeName = ActionTypeSupport.get_type_name(); 
            ActionTypeSupport.register_type(participant, typeName);
            ...
            ++count) {
                System.out.println("Action subscriber sleeping for "
        ...
        public void on_data_available(DataReader reader) {
            ...
            try {
                ...
                for(int i = 0; i < _dataSeq.size(); ++i) {
                    ...
                    if (info.valid_data) {
                        System.out.println(
                            ((Action)_dataSeq.get(i)).toString("Received",0));
