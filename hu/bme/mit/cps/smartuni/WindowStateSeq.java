...
/**
* A sequence of WindowState instances.
*/
public final class WindowStateSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WindowStateSeq() {
        super(WindowState.class);
    }

    public WindowStateSeq (int initialMaximum) {
        super(WindowState.class, initialMaximum);
    }

    public WindowStateSeq (Collection<?> elements) {
        super(WindowState.class, elements);
    }

    public  WindowState get(int index) { 
        return (WindowState) super.get(index); 
    }
