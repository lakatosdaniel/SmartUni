...
public class WindowStateTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "WindowState";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WindowStateTypeSupport _singleton
    = new WindowStateTypeSupport();
    ...
    */
    public static WindowStateTypeSupport get_instance() {
        return _singleton;
    }

    public static WindowStateTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WindowStateTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return WindowState.create();
    }
    ...
    * <code>this</code> is not a <code>WindowState</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        WindowState typedDst = (WindowState) destination;
        WindowState typedSrc = (WindowState) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        WindowState typedSrc = (WindowState) sample;
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.IsOpen);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WindowState typedDst = (WindowState) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                ...
                typedDst.IsOpen = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WindowState typedDst = (WindowState) sample;
            deserialize_sample(
    ...
    int mask) {
        return new WindowStateDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WindowStateDataReader(native_reader, listener, mask, this);   
    ...
    protected WindowStateTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, WindowStateTypeCode.VALUE, WindowState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WindowStateTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, WindowStateTypeCode.VALUE, WindowState.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
