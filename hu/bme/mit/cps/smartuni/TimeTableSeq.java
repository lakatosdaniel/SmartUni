...
/**
* A sequence of TimeTable instances.
*/
public final class TimeTableSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TimeTableSeq (int initialMaximum) {
        super(TimeTable.class, initialMaximum);
    }

    public TimeTableSeq (Collection<?> elements) {
        super(TimeTable.class, elements);
    }

    public  TimeTable get(int index) { 
        return (TimeTable) super.get(index); 
    }
