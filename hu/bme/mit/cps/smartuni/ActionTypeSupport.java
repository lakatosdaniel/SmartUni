...
public class ActionTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "Action";
    ...
    */
    ...
    public Object copy_data(Object destination, Object source) {
        ...
        Action typedDst = (Action) destination;
        Action typedSrc = (Action) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getLongMaxSizeSerialized(currentAlignment) ;
        currentAlignment += hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.Action);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += _cdrPrimitiveType.getLongMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.Action, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ...
                dst.inBaseClass = false;
                dst.writeLong(typedSrc.TimeStamp);
                hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.Action, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.Action = (hu.bme.mit.cps.smartuni.ActionKind)hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.Action, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.cps.smartuni.ActionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
    ...
    int mask) {
        return new ActionDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ActionDataReader(native_reader, listener, mask, this);   
    ...
    protected ActionTypeSupport() {
        ...
        super(TYPE_NAME, false, ActionTypeCode.VALUE, Action.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ActionTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, ActionTypeCode.VALUE, Action.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
