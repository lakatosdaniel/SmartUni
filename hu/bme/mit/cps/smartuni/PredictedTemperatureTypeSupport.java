...
public class PredictedTemperatureTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "PredictedTemperature";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PredictedTemperatureTypeSupport _singleton
    = new PredictedTemperatureTypeSupport();
    ...
    */
    public static PredictedTemperatureTypeSupport get_instance() {
        return _singleton;
    }

    public static PredictedTemperatureTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PredictedTemperatureTypeCode.VALUE;
    }

    @Override
    public Object create_data() {
        return PredictedTemperature.create();
    }
    ...
    public Object create_key() {
        return new PredictedTemperature();
    }
    ...
    public Class<?> get_type() {
        return PredictedTemperature.class;
    }
    ...
    * <code>this</code> is not a <code>PredictedTemperature</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        PredictedTemperature typedDst = (PredictedTemperature) destination;
        PredictedTemperature typedSrc = (PredictedTemperature) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getLongMaxSizeSerialized(currentAlignment) ;
        currentAlignment += hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        PredictedTemperature typedSrc = (PredictedTemperature) sample;
        ...
        currentAlignment += hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,final_encapsulation_id,currentAlignment,typedSrc.Prediction);
        ...
        long currentAlignment) 
    {
        ...
        currentAlignment += _cdrPrimitiveType.getLongMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().get_serialized_key_for_keyhash_max_size(endpoint_data,false, final_encapsulation_id,currentAlignment);
        if (include_encapsulation) {
            currentAlignment += encapsulation_size;
        }
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.Prediction, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            if(!xcdr1){            
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (xcdr1){
            ...
            if (serialize_key) {
                ...
                dst.inBaseClass = false;
                dst.writeLong(typedSrc.TimeStamp);
                hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().serialize_key_for_keyhash(endpoint_data, typedSrc.Prediction, dst, false, final_encapsulation_id,true,endpoint_plugin_qos);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PredictedTemperature typedDst = (PredictedTemperature) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
            ...
            try{
                ...
                typedDst.Prediction = (hu.bme.mit.cps.smartuni.PredictionKind)hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.Prediction, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            hu.bme.mit.cps.smartuni.PredictionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PredictedTemperature typedDst = (PredictedTemperature) sample;
            deserialize_sample(
    ...
    int mask) {
        return new PredictedTemperatureDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new PredictedTemperatureDataReader(native_reader, listener, mask, this);   
    ...
    protected PredictedTemperatureTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, PredictedTemperatureTypeCode.VALUE, PredictedTemperature.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PredictedTemperatureTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, PredictedTemperatureTypeCode.VALUE, PredictedTemperature.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
