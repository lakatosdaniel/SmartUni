...
public class TimeTableTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "TimeTable";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final TimeTableTypeSupport _singleton
    = new TimeTableTypeSupport();
    ...
    */
    public static TimeTableTypeSupport get_instance() {
        return _singleton;
    }

    public static TimeTableTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return TimeTableTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>TimeTable</code>
    * type.
    */
    @Override 
    public Object copy_data(Object destination, Object source) {

        TimeTable typedDst = (TimeTable) destination;
        TimeTable typedSrc = (TimeTable) source;
        ...
        Object sample) 
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        TimeTable typedSrc = (TimeTable) sample;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            TimeTable typedDst = (TimeTable) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            TimeTable typedDst = (TimeTable) sample;
            deserialize_sample(
    ...
    int mask) {
        return new TimeTableDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new TimeTableDataReader(native_reader, listener, mask, this);   
    ...
    protected TimeTableTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, TimeTableTypeCode.VALUE, TimeTable.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected TimeTableTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, TimeTableTypeCode.VALUE, TimeTable.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
