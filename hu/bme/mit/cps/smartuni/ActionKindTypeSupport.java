...
public class ActionKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "ActionKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ActionKindTypeSupport _singleton
    = new ActionKindTypeSupport();
    ...
    */
    public static ActionKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ActionKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ActionKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ActionKind</code>
    * type.
    */
    @Override 
    ...
    short final_encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        int position = 0;
        ActionKind typedSrc = (ActionKind) src;
    ...
    protected ActionKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, ActionKindTypeCode.VALUE, ActionKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
