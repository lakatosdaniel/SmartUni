...
data type Action from schema.idl.
This example builds two applications, named ActionPublisher
and ActionSubscriber.
...
open/double-click and edit the ActionPublisher.java file
where it says:
...
> ant ActionPublisher
or
> ant ActionSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the ActionPublisher or ActionSubscriber
application.
...
Make sure that java and javac are in your path before you start. From your
command shell, type:
> make -f makefile_schema_x64Linux3gcc5.4.0 ActionPublisher
> make -f makefile_schema_x64Linux3gcc5.4.0 ActionSubscriber
